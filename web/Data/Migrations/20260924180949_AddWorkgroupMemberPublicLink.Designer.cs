...
namespace web.Data.Migrations
{
    ...
    [Migration("20260924180949_AddWorkgroupMemberPublicLink")]
    partial class AddWorkgroupMemberPublicLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityListCellValue", b =>
                {
                    ...
                    b.Property<int>("ActivityListColumnId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ActivityListItemId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ActivityListColumnId");
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityListItem", b =>
                {
                    ...
                    b.Property<int?>("UpdatedByWorkgroupMemberId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UpdatedByWorkgroupMemberId");
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityFile", b =>
                {
                    ...
                    b.HasOne("web.Data.Entities.ActivityFolder", "Folder")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityFileVersion", b =>
                {
                    b.HasOne("web.Data.Entities.ActivityFile", "ActivityFile")
                        .WithMany("Versions")
                        .HasForeignKey("ActivityFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("web.Data.Entities.ApplicationUser", "UploadedByUser")
                        .WithMany()
                        .HasForeignKey("UploadedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ActivityFile");
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityFolder", b =>
                {
                    ...
                    b.HasOne("web.Data.Entities.ActivityFolder", "ParentFolder")
                        .WithMany("SubFolders")
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityListCellValue", b =>
                {
                    b.HasOne("web.Data.Entities.ActivityListColumn", "Column")
                        .WithMany("Values")
                        .HasForeignKey("ActivityListColumnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("web.Data.Entities.ActivityListItem", "Item")
                        .WithMany("Values")
                        .HasForeignKey("ActivityListItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityListColumn", b =>
                {
                    b.HasOne("web.Data.Entities.ActivityList", "ActivityList")
                        .WithMany("Columns")
            ...
            modelBuilder.Entity("web.Data.Entities.ActivityListItem", b =>
                {
                    ...
                    b.HasOne("web.Data.Entities.ActivityListStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("web.Data.Entities.ApplicationUser", "UpdatedByUser")
                        .WithMany()
                        .HasForeignKey("UpdatedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("web.Data.Entities.ActivityWorkgroupMember", "UpdatedByWorkgroupMember")
                        .WithMany()
                        .HasForeignKey("UpdatedByWorkgroupMemberId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("UpdatedByWorkgroupMember");
                });
